...
RULES = {
    ...
    "domain:cloud-infra": [r"\bcloud\b", r"\binfrastructure\b", r"\bdeployment\b", r"\bkubernetes\b", r"\bserverless\b", r"\bgke\b", r"\bcloud run\b", r"\bcloudflare\b", r"\bdurable objects\b"],
    ...
    "domain:design": [r"\bdesign\b", r"\bvisual\b", r"\btypograph", r"\bcolor\b", r"\bbrand\b", r"\bfigma\b", r"\baesthetic\b", r"\b(algorithmic|generative) art\b"],
    ...
    "domain:devops": [r"\bci/?cd\b", r"\bpipeline\b", r"\bgithub actions\b", r"\bdocker\b", r"\brelease\b", r"\bmonitoring\b", r"\bobservability\b", r"\bpull requests?\b", r"\bpr (titles?|descriptions?|reviews?|comments?|ci)\b", r"\bcommit messages?\b", r"\bgit branch"],
    ...
    "domain:docs-writing": [r"\bdocumentation\b", r"\bdocs\b", r"\bwriting\b", r"\breadme\b", r"\bchangelog\b", r"\bcopywriting\b", r"\bobsidian\b", r"\bnotion\b", r"\binternal comm"],
    "domain:product": [r"\bproduct\b", r"\broadmap\b", r"\bmvp\b", r"\bfeature spec\b", r"\buser stor", r"\bokrs?\b", r"\bprioriti[sz]ation\b", r"\bsprint\b", r"\bstakeholders?\b"],
    "domain:marketing": [r"\bmarketing\b", r"\bseo\b", r"\bcampaign\b", r"\bads?\b", r"\blaunch post\b", r"\bsocial media\b", r"\bchurn\b", r"\bcold emails?\b", r"\breferral", r"\bpopups?\b", r"\bsignup\b"],
    ...
    "domain:agent-workflow": [r"\bhand ?off\b", r"\bretro(spective)?\b", r"\bcontext (window|management|engineering)\b", r"\bprompt(ing|s)?\b", r"\bsub-?agent\b", r"\bskill (author|creat|writ)", r"\bagents?\.md\b", r"\bclaude\.md\b", r"\bparallel agents\b"],
